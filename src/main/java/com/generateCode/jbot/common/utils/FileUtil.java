package com.generateCode.jbot.common.utils;
...
public class FileUtil {
    ...
    public static void createFileByFreemarker(String template, String fileName, HashMap<String, Object> renderMap) throws CustomException {

        File javaFile = new File(fileName);
        OutputStream fos = null;
        try {
            // 1. 获取文件所在文件夹
            if (javaFile.getParentFile() != null && !javaFile.getParentFile().exists()) {
