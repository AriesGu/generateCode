package com.generateCode.jbot.web.rest;
...
public class JbotRest {
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "projectName", value = "项目名", required = true, dataType = "string", paramType = "query"),
            @ApiImplicitParam(name = "packageName", value = "包名", required = true, dataType = "string", paramType = "query"),
            @ApiImplicitParam(name = "authorName", value = "作者名", required = true, dataType = "string", paramType = "query")
    })
    @ApiResponses({
            @ApiResponse(code = 400, message = "IllegalParam")
    })
    ...
    public Map<String, Object> produceProject(
        ...
        return jbotService.produceProject(projectName, packageName,authorName, dbInfo, response);
    }
}
