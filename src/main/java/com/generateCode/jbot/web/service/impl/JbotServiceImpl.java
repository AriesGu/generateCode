package com.generateCode.jbot.web.service.impl;
...
import com.generateCode.jbot.common.utils.MysqlUtil;
import com.generateCode.jbot.common.utils.StringUtil;
import com.generateCode.jbot.core.Launch;
import com.generateCode.jbot.web.dao.JbotDao;
import com.generateCode.jbot.web.entity.ConnectInfo;
import com.generateCode.jbot.web.entity.DbInfo;
import com.generateCode.jbot.common.security.Interceptor;
import com.generateCode.jbot.web.service.JbotService;
...
public class JbotServiceImpl implements JbotService {
    ...
    @Override
    public Map<String, Object> produceProject(String projectName, String packageName, String authorName ,DbInfo dbInfo, HttpServletResponse response) throws CustomException {
        Map<String, Object> result = new HashMap<>(16);
        //1 检测项目名是否合法
        ...
        //3 调用生成项目的入口类
        if (Launch.start(projectName, packageName, authorName, dbInfo)) {
            //3.1 下载生成的项目
            FileUtil.download(Collective.TARGET_PROJECT_HOME + "/" + projectName + ".zip", response);
            //3.2 删除生成的项目文件
