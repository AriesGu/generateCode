...
```
POST http://127.0.0.1:8080/project/users/user
```
...
```
DELETE http://127.0.0.1:8080/project/users/user/1
```
...
```
PUT http://127.0.0.1:8080/project/users/user
```
...
```
GET http://127.0.0.1:8080/project/users/user/1
```
...
```
GET http://127.0.0.1:8080/project/users
```
